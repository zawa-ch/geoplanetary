	...
	<article v-else :class="$style.article" @contextmenu.stop="onContextmenu">
		...
		<div :class="$style.main">
			...
			<div style="container-type: inline-size;">
				...
				<div v-show="appearNote.cw == null || showContent" :class="[{ [$style.contentCollapsed]: collapsed }, {[$style.notecontentOverflow]: prefer.s.overflowLongNotes}]">
			...
			<footer :class="$style.footer">
				...
				<button v-if="prefer.s.showClipButtonInNoteFooter && ($i?.policies.clipAvailable || $i?.isAdmin)" ref="clipButton" :class="$style.footerButton" class="_button" @mousedown.prevent="clip()">
...
const canRenote = computed(() => ($i?.policies.canQuote ?? true) && (['public', 'home'].includes(appearNote.visibility) || (appearNote.visibility === 'followers' && appearNote.userId === $i?.id)));
