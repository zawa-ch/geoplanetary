...
export type RoleCondFormulaValueUserSettingBoolean = components['schemas']['RoleCondFormulaValueUserSettingBoolean'];
...
export type RoleCondFormulaValueLoggedIn = components['schemas']['RoleCondFormulaValueLoggedIn'];
export type RoleCondFormulaFollowersOrFollowingOrNotes = components['schemas']['RoleCondFormulaFollowersOrFollowingOrNotes'];
export type RoleCondFormulaValueZeroArg = components['schemas']['RoleCondFormulaValueZeroArg'];
export type RoleCondFormulaValuePatternMatch = components['schemas']['RoleCondFormulaValuePatternMatch'];
export type RoleCondFormulaValueEntropy = components['schemas']['RoleCondFormulaValueEntropy'];
export type RoleCondFormulaValueBlurhashLikely = components['schemas']['RoleCondFormulaValueBlurhashLikely'];
